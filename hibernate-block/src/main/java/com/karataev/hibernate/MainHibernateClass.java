package com.karataev.hibernate;

import com.karataev.hibernate.entities.Author;
import com.karataev.hibernate.entities.Book;
import com.karataev.hibernate.entities.Reader;
...
//            session.beginTransaction();
//            session
//                    .createQuery("update Catalog c set title ='Fantastic #1' where c.id=1")
//                    .executeUpdate();
//            session
